...
function booking_send_notification_email( $status = '', $bookopts = '' ) {
 ...
 $user = get_user_by( 'email', $bookopts['bizzthemes_bookings_email'] );
		...
		$replacements  = array(
			...
			<tr><td>'.__('Account login', 'bizzthemes').' </td><td>'.$user->user_login .'</td></tr><tr><td>'.__('Account password', 'bizzthemes').' </td><td>'.$user->user_pass.'</td></tr>
