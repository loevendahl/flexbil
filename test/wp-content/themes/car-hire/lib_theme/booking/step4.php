...
?>
		...
		<div class="form-horizontal">
			...
			<div class="credit-card-payment">
				<div class="form-group">
					<label class="col-sm-5 control-label" for="cc_type"><?php _e('CC Type', 'bizzthemes'); ?><span class="req">*</span></label>
					<div class="col-sm-7">
						<select id="cc_type" name="cc_type" class="form-control col-md-12 validate">
							<option value=""><?php _e('-- Select --', 'bizzthemes'); ?></option>
							<option value="visa"><?php _e('Visa', 'bizzthemes'); ?></option>
							<option value="mastercard"><?php _e('MasterCard', 'bizzthemes'); ?></option>
							<option value="maestro"><?php _e('Maestro', 'bizzthemes'); ?></option>
							<option value="amex"><?php _e('AmericanExpress', 'bizzthemes'); ?></option>
						</select>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-5 control-label" for="cc_number"><?php _e('CC Number', 'bizzthemes'); ?><span class="req">*</span></label>
					<div class="col-sm-7">
						<input type="text" id="cc_number" name="cc_number" class="form-control col-md-12 validate" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-5 control-label" for="cc_expiration_m"><?php _e('Expiration Date', 'bizzthemes'); ?><span class="req">*</span></label>
					<div class="col-sm-7">
						<div class="row">
							<div class="col-md-6">
							<select id="cc_expiration_m" name="cc_expiration_m" class="form-control col-md-12 validate">
								<option value=""><?php _e('-- Select --', 'bizzthemes'); ?></option>
<?php
								for ($i = 1; $i <= 12; $i++) {
...
?>
							...
							<div class="col-md-6">
							<select id="cc_expiration_y" name="cc_expiration_y" class="form-control col-md-12 validate">
								<option value=""><?php _e('-- Select --', 'bizzthemes'); ?></option>
<?php
								$current_year = date("Y");
								$final_year = $current_year + 16;
								for ($i = $current_year; $i <= $final_year; $i++) {
...
?>
				...
				<div class="form-group">
					<label class="col-sm-5 control-label" for="cc_security"><?php _e('CC Security Code', 'bizzthemes'); ?><span class="req">*</span></label>
					<div class="col-sm-7">
						<input type="text" id="cc_security" name="cc_security" class="form-control col-md-12 validate" />
					</div>
				</div>
			</div>
		</div>
