...
//added KL	, add booking user to WP
  if( false == get_user_by( 'email', $form_data['email'] ) ) {
      // The user doesn't exist
	     $userdata = array(
        'user_login'    =>   $form_data['first_name'].$this_post_id,
        'user_email'    =>   $form_data['email'],
        'user_pass'     =>   $bookopts['tracking_id'],
		...
		$bookopts['customer_wpuser'] 			= $userdata['user_login'];
		
		 $bookopts['customer_wppass']			= $userdata['user_pass'];
    }
//
